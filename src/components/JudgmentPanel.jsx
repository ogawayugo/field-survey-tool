...
import { generateAppearanceReason, generateOverallReason } from '../lib/generateJudgmentReason.js';

export const JudgmentButton = memo(function JudgmentButton({ value, current, onChange, compact }) {
