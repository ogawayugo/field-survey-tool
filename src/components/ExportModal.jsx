...
export default memo(function ExportModal({ treeCount, totalPhotos, copiedFlash, onExportJSON, onCopyText, onClose }) {
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center p-4" style={{ background: 'rgba(40, 30, 20, 0.5)' }}>
      <div className="bg-white border border-stone-300 max-w-md w-full">
        <div className="border-b border-stone-200 px-5 py-4 flex items-center justify-between" style={{ background: '#f4ede0' }}>
          <div>
